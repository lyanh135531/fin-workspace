...
import { payCreditCardAction, refundCreditCardExpenseAction, registerCreditCardInstallmentAction } from "@/app/dashboard/actions";
...
type CardActivity = {
  id: string; originalTransactionId: string | null;
  ...
  refundableAmount?: string; installmentEligible: boolean; installmentPlanId: string | null;
};
