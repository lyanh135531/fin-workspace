...
export function GeneralWorkspaceActions({ canCreateMember }: { canCreateMember: boolean }) {
  return (
    <Card as="section" className="sunrise-card gap-0 mt-6 p-6">
      <p className="settings-eyebrow">Nhóm tài chính & quyền truy cập</p>
      <h2 className="mt-1 text-xl font-semibold">Quản lý nhóm</h2>
      <p className="mt-2 text-sm text-slate-500">
        Tạo nhóm mới, tham gia nhóm bằng mã mời hoặc cấp tài khoản cho thành viên.
      </p>
      <div className="mt-5 grid gap-3 md:grid-cols-2 xl:grid-cols-3">
        <Card as="a" className="general-action-card gap-0 py-0" href="/workspaces/create">
          ...
          <strong>Tạo nhóm tài chính</strong>
          <small>Bạn sẽ là quản trị viên của nhóm mới.</small>
        </Card>
        <Card as="a" className="general-action-card gap-0 py-0" href="/settings/join">
          ...
          <strong>Tham gia nhóm tài chính</strong>
        ...
        {canCreateMember && (
          <Card as="a" className="general-action-card gap-0 py-0" href="/settings/users">
            ...
            <small>Cấp quyền thành viên cho nhóm bạn quản trị.</small>
          </Card>
        )}
      </div>
    </Card>
