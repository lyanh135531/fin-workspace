  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        week: cn("mt-1 flex w-auto gap-1", defaultClassNames.week),
        ...
        today: cn(
          ...
          "rounded-(--cell-radius) bg-transparent text-primary font-semibold data-[selected=true]:rounded-(--cell-radius)",
        ),
        outside: cn(
...
function CalendarDropdown({
  ...
  return (
    <Select
      ...
      className="h-7 w-auto min-w-0 gap-1 border-0 bg-transparent px-1.5 text-xs font-semibold shadow-none hover:bg-accent focus-visible:ring-1 dark:bg-transparent dark:hover:bg-accent"
      contentClassName={options.length > 12 ? "max-h-72" : undefined}
      size="sm"
    />
  );
}
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "relative isolate z-10 flex aspect-square size-auto w-full min-w-(--cell-size) flex-col gap-1 border-0 leading-none font-normal focus-visible:relative focus-visible:z-10 focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 data-[range-end=true]:rounded-(--cell-radius) data-[range-end=true]:rounded-r-(--cell-radius) data-[range-end=true]:bg-primary data-[range-end=true]:text-primary-foreground data-[range-middle=true]:rounded-none data-[range-middle=true]:bg-muted data-[range-middle=true]:text-foreground data-[range-start=true]:rounded-(--cell-radius) data-[range-start=true]:rounded-l-(--cell-radius) data-[range-start=true]:bg-primary data-[range-start=true]:text-primary-foreground data-[selected-single=true]:bg-primary data-[selected-single=true]:text-primary-foreground dark:hover:text-foreground [&>span]:text-xs [&>span]:opacity-70",
        defaultClassNames.day,
        className,
      )}
      {...props}
