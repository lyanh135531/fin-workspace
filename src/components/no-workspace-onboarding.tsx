    ...
    <div className="mx-auto max-w-5xl space-y-8 py-4 sm:py-6">
      ...
      >
        <div className="relative z-10 max-w-3xl space-y-3">
          ...
          <p className="text-sm leading-relaxed text-slate-500 sm:text-base">
            Bạn hiện chưa thuộc về workspace nào. Bắt đầu ngay bằng cách tạo một
            không gian làm việc mới của riêng bạn hoặc tham gia vào workspace đã
            có của nhóm.
          </p>
        </div>
      </Card>
            ...
            <div className="flex-1 space-y-2">
              <div className="flex items-center justify-between gap-2">
                <h3 className="font-semibold text-amber-800 dark:text-amber-300">
                  Bạn có {pendingRequests.length} yêu cầu tham gia đang chờ
                  Admin duyệt
                </h3>
                <Link
                  href="/settings/join"
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        >
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex h-12 w-12 items-center justify-center bg-[var(--coral)]/15 text-[var(--coral)]">
                <Building2 size={24} />
              </div>
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-relaxed text-slate-500">
                Tạo một không gian dữ liệu mới độc lập để quản lý ví tiền, danh
                mục thu chi, thành viên và duyệt giao dịch. Bạn sẽ trở thành{" "}
                <strong>Admin</strong> của workspace này.
              </p>
            </div>
          </div>
        ...
        >
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex h-12 w-12 items-center justify-center bg-blue-500/15 text-blue-500">
                <KeyRound size={24} />
              </div>
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-relaxed text-slate-500">
                Nhập Mã mời (Invite Code) do Admin workspace chia sẻ với bạn để
                gửi yêu cầu gia nhập vào nhóm hoặc tổ chức đã sẵn có.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 pt-4 border-t border-[var(--border)]">
            <Button
              variant="outline"
              render={<Link href="/settings/join" />}
              className="w-full justify-center"
            >
              <KeyRound size={18} />
              Nhập mã tham gia
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-[var(--border)] bg-[var(--surface-muted)] p-4">
            <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-[var(--coral)]">
              <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[var(--coral)] text-white text-[10px]">
                1
              </span>
              Bước 1 (Hiện tại)
            </div>
            ...
            <p className="mt-1 text-xs text-slate-500">
              Khởi tạo dữ liệu riêng hoặc liên kết với tổ chức của bạn.
            </p>
          </div>

          <div className="rounded-xl border border-[var(--border)] bg-[var(--surface-muted)] p-4 opacity-75">
            <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-slate-400">
              <span className="flex h-5 w-5 items-center justify-center rounded-full bg-slate-400 text-white text-[10px]">
                2
              </span>
              Bước 2
            </div>
            <p className="mt-2 text-sm font-semibold text-[var(--foreground)]">
              Thiết lập Ví & Danh mục
            </p>
            <p className="mt-1 text-xs text-slate-500">
              Tạo các tài khoản thanh toán và tùy chỉnh nhóm thu chi.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-[var(--border)] bg-[var(--surface-muted)] p-4 opacity-75">
            ...
            <p className="mt-1 text-xs text-slate-500">
              Bắt đầu nhập các khoản thu, chi và theo dõi báo cáo tài chính.
            </p>
          </div>
        </div>
      </Card>
